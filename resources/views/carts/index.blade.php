			...
			<div class="col-md-8">
				...
				<div class="row justify-content-end">
					<div class="col-md-3 mb-4">
						<a href="{{ route('products.index') }}" class="btn ecmart-favorite-button text-favorite w-100">
							買い物を続ける
						</a>
					</div>
					...
					<div class="col-md-3 mb-4">
						@if ($total > 0)
							<a href="{{ route('checkout.index') }}" class="btn ecmart-submit-button text-white w-100">購入に進む</a>
						@else
							<button class="btn ecmart-submit-button-disabled w-100">購入に進む</button>
						@endif
					</div>
				</div>
			</div>
