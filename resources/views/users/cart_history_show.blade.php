						...
						<div class="col-md-5">
							<a href="{{ route('products.show', $product->id) }}" class="ml-4">
								@if ($product->options->image)
									<img src="{{ asset($product->options->image) }}" class="img-thumbnail ecmart-product-img-cart-history">
								@else
									<img src="{{ asset('img/dummy.png') }}" class="img-thumbnail ecmart-product-img-cart-history">
								@endif
							</a>
						</div>
						<div class="col-md-7">
