					...
					<div class="col-md-7 mt-2">
						<div class="d-inline-flex">
							...
							<div class="container mt-3">
								...
								<h6 class="w-100 ecmart-favorite-item-text">&yen;{{ $favorite_product->price }}</h6>
							</div>
						</div>
					</div>
					<div class="col-md-2 d-flex align-items-center justify-content-end">
						<a href="{{ route('favorites.destroy', $favorite_product->id) }}" class="btn ecmart-favorite-item-delete"
