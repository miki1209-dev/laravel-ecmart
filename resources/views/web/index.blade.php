		...
		<div class="col-9">
			...
			<div class="row">
				@foreach ($recommend_products as $recommend_product)
					<div class="col-4">
						<a href="{{ route('products.show', $recommend_product->id) }}">
						...
						<div class="row">
							<div class="col-12">
								<p class="ecmart-product-label">{{ $recommend_product->name }}<br><label>{{ $recommend_product->price }}</label>
								</p>
							</div>
						</div>
					</div>
			...
			<div class="row">
				@foreach ($recently_products as $recently_product)
					<div class="col-3">
						<a href="{{ route('products.show', $recently_product->id) }}">
						...
						<div class="row">
							<div class="col-12">
								<p class="ecmart-product-label mt-2">
									{{ $recently_product->name }}<br><label>{{ $recently_product->price }}</label></p>
							</div>
						</div>
					</div>
				@endforeach
